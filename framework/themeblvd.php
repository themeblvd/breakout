...
// Constants
define( 'TB_FRAMEWORK_VERSION', '2.1.0' );
...
if( is_admin() ) {
	...
	add_action( 'themeblvd_featured_blog', 'themeblvd_featured_blog_default' );
	...
	add_action( 'themeblvd_featured_below_blog', 'themeblvd_featured_below_blog_default' );
