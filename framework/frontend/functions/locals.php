...
function themeblvd_get_all_locals() {
	$locals = array ( 
		...
		'comment'					=> __( 'Comment', TB_GETTEXT_DOMAIN ),
		...
		'login_text'				=> __( 'Log in to Reply', TB_GETTEXT_DOMAIN ),
		...
		'reply'						=> __( 'Reply', TB_GETTEXT_DOMAIN ),
